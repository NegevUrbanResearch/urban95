...
Run from repo root:
    $env:PYTHONPATH="src"; python -m pipeline run shade
"""
...
from core.paths import DOCS_DATA_DIR, OUTPUT_DIR, layer
...
STREET_RAW_PATH = layer("shade_street").path
OPEN_SPACE_RAW_PATH = layer("shade_open_space").path

SHADE_SI_DIR = OUTPUT_DIR / "shade_si"
CALIBRATION_PATH = OUTPUT_DIR / "shade_si_calibration.json"
